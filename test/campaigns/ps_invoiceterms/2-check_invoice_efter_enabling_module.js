scenario('Test Case n°2 : Check invoices when the module is enabled', () => {
    scenario('Enable the module', () => {
        ...
        scenario('Enable the "ps_invoiceterms" module', client => {
            ...
            test('should click on "Enable" button', () => client.clickEnableModuleButton('ps_invoiceterms'));
        }, 'ps_invoiceterms_client');
    ...
    scenario('Check that the terms exist in the invoice', client => {
        test('should login successfully in BO', () => client.signInBO());
        ...
        test('should check that the terms exist in the invoice', () => client.checkTermsOnInvoice('1', 'Conditions d\'utilisation'));
    }, 'ps_invoiceterms_client');
